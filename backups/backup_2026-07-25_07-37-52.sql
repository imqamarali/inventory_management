...
CREATE TABLE `activitylogs` (
  ...
  `activitytype` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `refid` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `backup_test` (
  `id` int NOT NULL,
  `test_data` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `backup_test` VALUES (999,'TEST DATA BEFORE BACKUP');
...
CREATE TABLE `inventory_brands` (
  `id` int NOT NULL AUTO_INCREMENT,
  `brand_name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `brand_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `inventory_categories` (
  ...
  `category_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `inventory_customers` (
  ...
  `customer_type` enum('Individual','Company') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Individual',
  ...
  `phone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mobile` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tax_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `inventory_email_config` (
  ...
  `smtp_password` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `encryption` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'tls',
...
CREATE TABLE `inventory_events` (
  ...
  `event_color` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '#3fb50f',
...
CREATE TABLE `inventory_goods_receiving` (
  `id` int NOT NULL AUTO_INCREMENT,
  `grn_number` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `inventory_logs` (
  ...
  `old_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `new_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
CREATE TABLE `inventory_notifications` (
  ...
  `notification_type` enum('Info','Success','Warning','Error') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Info',
...
CREATE TABLE `inventory_payments` (
  `id` int NOT NULL AUTO_INCREMENT,
  `payment_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `payment_date` date DEFAULT NULL,
  `payment_type` enum('Receive','Pay') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `reference_type` enum('Customer','Supplier') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `reference_id` int DEFAULT NULL,
  `payment_method` enum('Cash','Bank','Cheque','Online') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `inventory_pos_sales` (
  `id` int NOT NULL AUTO_INCREMENT,
  `pos_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `payment_method` enum('Cash','Card','Bank','Online') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Cash',
  `payment_status` enum('Unpaid','Partial','Paid') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Unpaid',
  `status` enum('Completed','Cancelled','Refunded') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Completed',
  `remarks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int DEFAULT NULL,
...
CREATE TABLE `inventory_products` (
  ...
  `barcode` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
CREATE TABLE `inventory_purchase_invoices` (
  ...
  `status` enum('Pending','Partial','Paid','Cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Pending',
  `remarks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT '1',
...
CREATE TABLE `inventory_purchase_orders` (
  ...
  `status` enum('Draft','Approved','Partially Received','Completed','Cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Draft',
  `subtotal` decimal(15,2) DEFAULT '0.00',
...
CREATE TABLE `inventory_purchase_returns` (
  `id` int NOT NULL AUTO_INCREMENT,
  `return_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `inventory_reports` (
  `id` int NOT NULL AUTO_INCREMENT,
  `report_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `report_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `inventory_sales_orders` (
  ...
  `order_status` enum('Draft','Confirmed','Packed','Dispatched','Delivered','Cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Draft',
...
CREATE TABLE `inventory_sales_returns` (
  `id` int NOT NULL AUTO_INCREMENT,
  `return_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sales_invoice_id` int NOT NULL,
  `customer_id` int NOT NULL,
  `return_date` date DEFAULT NULL,
  ...
  `tax_amount` decimal(15,2) DEFAULT '0.00',
  `grand_total` decimal(15,2) DEFAULT '0.00',
  `status` enum('Pending','Approved','Completed','Cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Pending',
  `remarks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int DEFAULT NULL,
...
CREATE TABLE `inventory_sms_config` (
  `id` int NOT NULL AUTO_INCREMENT,
  `api_provider` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `inventory_stock_adjustments` (
  `id` int NOT NULL AUTO_INCREMENT,
  `adjustment_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `warehouse_id` int NOT NULL,
  `adjustment_date` date DEFAULT NULL,
  `adjustment_type` enum('Increase','Decrease') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `reason` enum('Damage','Expired','Lost','Correction','Other') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remarks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int DEFAULT NULL,
...
CREATE TABLE `inventory_stock_audits` (
  `id` int NOT NULL AUTO_INCREMENT,
  `audit_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `warehouse_id` int DEFAULT NULL,
  `audit_date` date DEFAULT NULL,
  `status` enum('Open','Completed') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Open',
  `remarks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int DEFAULT NULL,
...
CREATE TABLE `inventory_stock_movements` (
  `id` int NOT NULL AUTO_INCREMENT,
  `movement_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `warehouse_id` int NOT NULL,
  `product_id` int NOT NULL,
  `reference_type` enum('Purchase','Sale','Transfer In','Transfer Out','Adjustment','Return Purchase','Return Sale','Opening Stock','Stock Audit') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `reference_id` int DEFAULT NULL,
  `movement_type` enum('IN','OUT') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `inventory_stock_transfers` (
  `id` int NOT NULL AUTO_INCREMENT,
  `transfer_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `from_warehouse` int NOT NULL,
  `to_warehouse` int NOT NULL,
  `transfer_date` date DEFAULT NULL,
  `status` enum('Pending','In Transit','Completed','Cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Pending',
  `remarks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int DEFAULT NULL,
...
CREATE TABLE `inventory_supplier_documents` (
  ...
  `document_file` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `inventory_suppliers` (
  `id` int NOT NULL AUTO_INCREMENT,
  `supplier_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `inventory_transactions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `transaction_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `transaction_date` date DEFAULT NULL,
  `reference_type` enum('Purchase','Sale','Payment','Receipt','Expense','Adjustment') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `reference_id` int DEFAULT NULL,
  `account_id` int NOT NULL,
  `transaction_type` enum('Debit','Credit') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `inventory_units` (
  `id` int NOT NULL AUTO_INCREMENT,
  `unit_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `inventory_vehicle_makes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `make_name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `make_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `country` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `website` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `inventory_vehicle_models` (
  ...
  `model_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `model_year` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `engine_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `engine_capacity` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fuel_type` enum('Petrol','Diesel','Hybrid','Electric','CNG') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Petrol',
  `transmission` enum('Manual','Automatic','CVT') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Manual',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int DEFAULT NULL,
...
CREATE TABLE `inventory_warehouses` (
  `id` int NOT NULL AUTO_INCREMENT,
  `warehouse_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `login_auth_settings` (
  ...
  `auth_method` enum('email','sms','both') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'email',
...
INSERT INTO `migration` VALUES ('m000000_000000_base',1784960305);
...
CREATE TABLE `otp_verification` (
  ...
  `delivery_method` enum('email','sms') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'email',
  `delivered_to` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=25825 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `permissions` VALUES (25800,97,1,3,1,1,1,1,1,'2026-07-25 04:09:29',1),(25801,103,1,3,1,1,1,1,1,'2026-07-25 04:09:29',1),(25802,97,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25803,99,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25804,100,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25805,101,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25806,102,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25807,103,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25808,104,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25809,106,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25810,108,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25811,109,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25812,112,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25813,114,1,1,1,1,1,1,1,'2026-07-25 05:51:26',1),(25814,97,1,2,1,1,1,1,1,'2026-07-25 07:16:23',1),(25815,99,1,2,1,1,1,1,1,'2026-07-25 07:16:23',1),(25816,100,1,2,1,1,1,1,1,'2026-07-25 07:16:23',1),(25817,101,1,2,1,1,1,1,1,'2026-07-25 07:16:23',1),(25818,102,1,2,1,1,1,1,1,'2026-07-25 07:16:23',1),(25819,103,1,2,1,1,1,1,1,'2026-07-25 07:16:23',1),(25820,104,1,2,1,1,1,1,1,'2026-07-25 07:16:23',1),(25821,106,1,2,1,1,1,1,1,'2026-07-25 07:16:23',1),(25822,108,1,2,1,1,1,1,1,'2026-07-25 07:16:23',1),(25823,109,1,2,1,1,1,1,1,'2026-07-25 07:16:23',1),(25824,114,1,2,1,1,1,1,1,'2026-07-25 07:16:23',1);
...
CREATE TABLE `system_contracts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `contract_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `contract_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `contract_type` enum('monthly','yearly') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'monthly',
  `contractor_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contractor_cnic` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contractor_phone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contractor_email` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contractor_address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `system_status` enum('active','inactive','suspended','expired') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `contract_description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `policy_description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `contractor_info` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `full_description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `attachment_file` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int DEFAULT NULL,
  `updated_by` int DEFAULT NULL,
...
CREATE TABLE `system_invoices` (
  ...
  `invoice_month` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `invoice_status` enum('draft','sent','pending','partial','paid','overdue','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `payment_status` enum('unpaid','partial','pending_approval','paid') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'unpaid',
  `paid_amount` decimal(15,2) DEFAULT '0.00',
  `remaining_amount` decimal(15,2) DEFAULT '0.00',
  `invoice_file` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int DEFAULT NULL,
  `updated_by` int DEFAULT NULL,
...
CREATE TABLE `system_payment_proofs` (
  ...
  `proof_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `document_file` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `admin_comments` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int DEFAULT NULL,
  `updated_by` int DEFAULT NULL,
...
CREATE TABLE `system_payments` (
  ...
  `transaction_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `payment_status` enum('pending','completed','failed','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int DEFAULT NULL,
  `updated_by` int DEFAULT NULL,
...
CREATE TABLE `system_users` (
  ...
  `status` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'active',
  ...
  `profile_picture` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'assets/images/avatars/default-avatar.jpg',
  ...
  `whatsapp` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `facebook` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pinterest` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `instagram` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `system_users` VALUES (1,'superadmin','$2y$10$QhqttUePrywOckLgsP.rTON3VtMLj9F7laOSnxO2WafaqST6ud5hy','qamarali@gmail.com','Qamar','Ali','active','0346-7607204',1,'2024-10-25 15:44:52','2026-07-25 06:25:17',1,0,'2026-07-25 06:25:17',0,'uploads/profile_pictures/1784818242_7d0ebb3f18.png','Street 15, Gulberg, Lahore','Pakistan','Islamabad','2007-07-27','Male','0346-7607204','https://facebook.com/qamarAli','https://linkedin.com/in/alikhan','https://instagram.com/ali.khan','Super Admin. Manages System Operations.',1,NULL,NULL,NULL),(2,'inventory_admin','$2y$10$YpoAPRT.GBfLWcyW1P7MF.hEMpk3x81qbfGi43U9hbAVQnK.LBi9O','inventoryadmin@gmail.com','Qamar Ali','Inventory Admin','active','03185657457',2,'2026-07-23 09:25:21','2026-07-25 07:15:57',1,0,'2026-07-25 07:15:57',0,'uploads/profile_pictures/1784827731_3c1637f0a1.png','Islamabad Capital Territory, Pakistan',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
...
-- Dump completed on 2026-07-25 12:37:54
