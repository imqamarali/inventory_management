            ...
            <div class="row">
                    ...
                    <div class="widget-box widget-color-blue2">
                        <div class="widget-header">
                            <h4 class="widget-title lighter smaller">
                                <?php echo htmlspecialchars($reports['role_name']); ?>
                ...
                <div class="col-sm-9" >
                    <div class="widget-box widget-color-green2">
                        <div class="widget-header">
                            <h4 class="widget-title lighter smaller">
                                <?php echo htmlspecialchars($reports['type']); ?>
                            ...
                            <div class="widget-toolbar" style="width: 35%;">
                                <div style="margin-right:10px;margin-top:2px">
                                    <select id="form-field-select-3" name="id" class="chosen-select form-control"
                                        ...
                                        <?php foreach ($reports['system_reports'] as $module): ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <label
                                                                ...
                                                                <input type="checkbox" class="permission-checkbox"
                                                                    ...
                                                                    <?php echo ($feature[$type] === 1) ? 'checked' : ''; ?>
                                                                    onchange="handleCheckboxChange('<?php echo $type; ?>', this, '<?php echo htmlspecialchars($feature['report_permission_id']); ?>', 2);" />
                                                                <i
...
function handleCheckboxChange(name, checkbox, permission_id, status) {

    var isChecked = checkbox.checked;
    var idToPost = permission_id;
    var data = {
        name: name,
        status: isChecked ? 1 : 0,
        permission_id: idToPost,
        type: status,
    ...
    $.ajax({
        url: 'index.php?r=modules/update_reports',
        type: 'POST',
        data: data,
