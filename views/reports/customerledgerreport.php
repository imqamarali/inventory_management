    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb" style="width:100%; display:flex; justify-content:space-between; align-items:center;">
                <li style="display:flex; align-items:center; gap:10px;">
                    ...
                    <span class="active">Customer Ledger</span>
                </li>
        ...
        <div style="padding:15px; background:#f5f5f5; border-radius:4px; margin-bottom:15px;">
            <form id="filter_form">
                <div style="display:flex; gap:10px; flex-wrap:wrap; align-items:center;">
                    <select name="customer_id" class="new-input" style="flex:1; min-width:200px; height:32px;">
        ...
        <div id="report_container" class="widget-main">
            <div class="alert alert-info text-center">
                <i class="ace-icon fa fa-users fa-3x" style="color:#6FB3E0;"></i>
...
<script>
    (function() {
        ...
        window.loadReport = function loadReport() {
            ...
            fetch('index.php?r=reports/customerledgerreport', {method: 'POST', body: new URLSearchParams(data)})
                .then(r => r.json())
                .then(d => {
                    Swal.close();
                    if (d.success) {
        ...
        function renderTable(rows) {
            ...
            html += '<th style="width:5%;">#</th><th>Customer Code</th><th>Name</th><th class="text-right">Credit Limit</th>';
            ...
            if (rows && rows.length > 0) {
                rows.forEach((row, idx) => {
                    ...
                    html += `<tr><td>${idx + 1}</td><td>${htmlEscape(row.customer_code)}</td><td><strong>${htmlEscape(row.name)}</strong></td>`;
        ...
        window.exportReport = function exportReport() {
            ...
            window.location.href = `index.php?r=reports/exportcustomerledger&${filters.toString()}`;
        };
