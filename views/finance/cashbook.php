    ...
    <div class="dashboard-header">
        <div>
            <h3>
                ...
                Cash Book
                <small>Cash Transactions Register</small>
            </h3>
        </div>
    ...
    <div class="stats-grid">
        <div class="stat-card blue">
            <div class="stat-header">
                <span class="stat-title">Receipts</span>
                <div class="stat-icon">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="7" style="text-align: center; padding: 30px;">
                                    ...
                                    <p style="color: #999; margin-top: 10px;">No cash book entries found</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
