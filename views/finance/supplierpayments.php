    ...
    <div class="dashboard-header">
        <div>
            <h3>
                ...
                Supplier Payments
                <small>Supplier Payment Records & Tracking</small>
            </h3>
        </div>
    ...
    <div class="stats-grid">
        <div class="stat-card red">
            <div class="stat-header">
                <span class="stat-title">Total Paid</span>
        ...
        <div class="stat-card purple">
            ...
            <div class="stat-subtitle">Payment Records</div>
        </div>

        <div class="stat-card orange">
            <div class="stat-header">
                <span class="stat-title">Avg. Payment</span>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="7" style="text-align: center; padding: 30px;">
                                    ...
                                    <p style="color: #999; margin-top: 10px;">No supplier payments found</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
