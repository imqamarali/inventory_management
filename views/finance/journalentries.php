...
<div class="page-content">
    ...
    <div class="dashboard-header">
        <div>
            <h3>
                ...
                Journal Entries
                <small>Financial Journal & Transaction Entries</small>
            </h3>
        </div>
    ...
    <div class="stats-grid">
        <div class="stat-card blue">
            ...
            <div class="stat-subtitle">All Journal Entries</div>
        </div>

        <div class="stat-card green">
            <div class="stat-header">
                <span class="stat-title">Total Debit</span>
                <div class="stat-icon"><i class="fa fa-arrow-right"></i></div>
            </div>
            <div class="stat-value">PKR 0</div>
            <div class="stat-subtitle">Debit Amount</div>
        </div>

        <div class="stat-card red">
            <div class="stat-header">
                <span class="stat-title">Total Credit</span>
                <div class="stat-icon"><i class="fa fa-arrow-left"></i></div>
            </div>
            <div class="stat-value">PKR 0</div>
            <div class="stat-subtitle">Credit Amount</div>
        </div>
        ...
        <div class="stat-card purple">
            ...
            <div class="stat-value">0</div>
            <div class="stat-subtitle">Monthly Entries</div>
        </div>
    </div>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="8" style="text-align: center; padding: 30px;">
                                    ...
                                    <p style="color: #999; margin-top: 10px;">No journal entries found</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
