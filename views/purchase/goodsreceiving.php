...
<script>
    ...
    function openGrnModal(grnData = null) {
        ...
        const referenceNo = isEdit ? (grnData.reference_no ?? '') : '';
        ...
        Swal.fire({
            ...
            html: `
                ...
                <input type="text" id="swal_reference_no" class="form-control" value="${referenceNo}">
                </div>
            ...
            preConfirm: () => {
                ...
                return {
                    ...
                    reference_no: $('#swal_reference_no').val(),
