...
if (!isset($pendingPurchases)) $pendingPurchases = [];
    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb" style="width:100%;">
                ...
                <li class="active">Pending Purchases</li>
            </ul>
        </div>
        ...
        <div class="widget-main">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover" id="pending_table">
                    ...
                    <tbody>
                        <?php foreach ($pendingPurchases as $key => $item) {
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button   onclick="approveOrder(<?= $item['id'] ?>)">
...
<script>
    ...
    function searchform(page = 1) {
        ...
        Swal.fire({
            title: 'Loading Pending Purchases...',
            text: 'Please wait',
        ...
        fetch('index.php?r=purchase/pendingpurchases', {
                method: 'POST',
                body: data
            })
            .then(res => res.json())
            .then(res => {
                ...
                if (res.success) {
                    renderPending(res.pendingPurchases);
                    renderPagination(res.page, res.totalPages);
                } else {
                    Swal.fire('Error', res.message || 'Failed to load pending purchases.', 'error');
                }
            })
            .catch(error => {
                console.error(error);
    ...
    function renderPending(rows) {
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                    <button class="btn-success" onclick="approveOrder(${item.id})">
                        <i class="fa fa-check"></i> Approve
                    </button>
    ...
    function approveOrder(id) {
        ...
        Swal.fire({
            ...
            text: 'The order status will be changed to Approved.',
            icon: 'question',
            ...
            fetch('index.php?r=purchase/pendingpurchases', {
                ...
                .catch(() => {
                    Swal.fire('Error', 'Unable to approve order.', 'error');
                });
