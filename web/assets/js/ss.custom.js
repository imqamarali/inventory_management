$(document).ready(function () {
  ...
  // Check if there are any tables with .example class
  if ($(".example").length === 0) {
    console.log("No tables with .example class found");
    return;
  }
...
/*--dropify--*/
$(document).ready(function () {
  // Check if Dropify is loaded
  if (typeof $.fn.dropify === "undefined") {
    console.warn("Dropify plugin not loaded");
    return;
  }
