...
!(function (a) {
  ...
  var b = function (a) {
    this.init("image", a, b.defaults),
      "on_error" in a.image &&
        ((this.on_error = a.image.on_error), delete a.image.on_error),
      "on_success" in a.image &&
        ((this.on_success = a.image.on_success), delete a.image.on_success),
      "max_size" in a.image &&
        ((this.max_size = a.image.max_size), delete a.image.max_size),
    ...
    a.extend(b.prototype, {
      ...
      render: function () {
        ...
        (this.$input = this.$tpl.find("input[type=hidden]:eq(0)")),
          ...
          (this.options.image.allowExt = this.options.image.allowExt || [
            "jpg",
            "jpeg",
            "png",
            "gif",
          ]),
          (this.options.image.allowMime = this.options.image.allowMime || [
            "image/jpg",
            "image/jpeg",
            "image/png",
            "image/gif",
          ]),
          (this.options.image.maxSize =
            a.max_size || this.options.image.maxSize || !1),
          ...
          this.$file
            ...
            .on("change", function () {
              var b =
                a.$file.val() || a.$file.data("ace_input_files")
          ...
          this.$file
            .off("file.error.ace")
            .on("file.error.ace", function (b, c) {
              a.on_error &&
                (c.error_count.ext > 0 || c.error_count.mime > 0
                  ? a.on_error(1)
                  : c.error_count.size > 0 && a.on_error(2));
            });
      },
    }),
  ...
  (function (a) {
    ...
    var b = function (a) {
      ...
      try {
        ...
        (c.type = "number"),
          (this.nativeUI =
            "number" === c.type && this.options.spinner.nativeUI === !0);
      } catch (d) {}
    };
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      a.extend(b.prototype, {
        ...
        activate: function () {
          if (this.$input.is(":visible"))
            if (
              ...
              for (var b = ["min", "max", "step"], c = 0; c < b.length; c++)
                b[c] in this.options.spinner &&
                  this.$input.attr(b[c], this.options.spinner[b[c]]);
            } else {
  ...
  (function (a) {
    ...
    var b = function (a) {
      ...
      try {
        ...
        (c.type = "range"),
          (this.nativeUI =
            "range" === c.type && this.options.slider.nativeUI === !0);
      } catch (d) {}
    };
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      a.extend(b.prototype, {
        ...
        activate: function () {
          if (this.$input.is(":visible"))
            if (
              ...
              for (var b = ["min", "max", "step"], c = 0; c < b.length; c++)
                b[c] in this.options.slider &&
                  (this.$input[0][b[c]] = this.options.slider[b[c]]);
  ...
  (function (a) {
    ...
    var b = function (a) {
      ...
      try {
        ...
        (c.type = "date"),
          (this.nativeUI =
            "date" === c.type && this.options.date.nativeUI === !0);
      } catch (d) {}
    };
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      a.extend(b.prototype, {
        ...
        activate: function () {
          if (
            (this.$input.is(":visible") && this.$input.focus(), this.nativeUI)
          )
