...
$config = [
    ...
    'components' => [
        ...
        'flasher' => [
            'class' => 'app\components\FlasherComponent',
        ],
        ...
        'user' => [
            ...
            'identityCookie' => [
                'name' => 'hsms_1',
                'path' => 'https://quantaaffix.com/'  // correct path for the basictest1 app.
            ]
...
if (YII_ENV_DEV) {
    ...
    // Debug and Gii modules removed (not required for TCPDF functionality)
